...
void screen_block_draw(padPt* Coord1, padPt* Coord2)
{
  ...
  screen_set_pen_mode();
  /*tgi_bar(mul05(Coord1->x+24),mul0375(Coord1->y^0x1FF),mul05(Coord2->x+24),mul0375(Coord2->y^0x1FF));*/
...
{
  screen_set_pen_mode();
  dot_at(Coord1->x+24,mul0375(Coord1->y^0x1FF));
