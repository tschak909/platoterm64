...
static uint8_t ACCESS_KEYS[] = {
  0x61, /* 0x80 a ɑ alpha */ 
  0x62, /* 0x81 b ß beta */
  0x63, /* 0x82 c not sure */
  0x64, /* 0x83 d δ delta */
  0x65, /* 0x84 e ' acute accent */
  0x67, /* 0x85 g æ ae */
  0x68, /* 0x86 h oe oe */
  0x6A, /* 0x87 j å a with ring */
  0x6B, /* 0x88 k ä a with diaeresis */
  0x6C, /* 0x89 l ƛ lambda */
  0x6D, /* 0x8A m μ mu */
  0x6E, /* 0x8B n ~ tilde */
  0x6F, /* 0x8C o ° degree */
  0x70, /* 0x8D p π pi */
  ...
  0x73, /* 0x90 s σ sigma */
  0x74, /* 0x91 t θ theta */
  0x75, /* 0x92 u ¨ diaeresis */
  0x76, /* 0x93 v hacek (upside down circumflex) */
  0x77, /* 0x94 w ϖ capital pi */
  0x78, /* 0x95 x ^ circumflex */
  0x30, /* 0x96 0 l-embed */
  0x31, /* 0x97 1 r-embed */
  0x35, /* 0x98 5 @ */
  0x36, /* 0x99 6 arrow */
  ...
  0x3a, /* 0x9c : ~ lower tilde */
  0x2c, /* 0x9d , delimiter */
  0x2f, /* 0x9e / \ */
  0x3d, /* 0x9f = not equal */
  0x79, /* 0xA0 y ö */
  0x41, /* 0xA1 A left arrow */
  0x58, /* 0xA2 X down arrow */
  0x44, /* 0xA3 D right arrow */
  0x57, /* 0xA4 W up arrow */
  0x43, /* 0xA5 C © */
  0x46, /* 0xA6 F ♦ */
  0x47, /* 0xA7 G Æ */
  0x48, /* 0xA8 H OE */
